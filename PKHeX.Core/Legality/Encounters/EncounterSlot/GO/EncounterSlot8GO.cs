namespace PKHeX.Core
{
    ...
    public sealed record EncounterSlot8GO : EncounterSlotGO
    {
        ...
        {
            int[]? moves = MoveLevelUp.GetEncounterMoves(pk, level, OriginGroup);
            pk.SetMoves(moves);
        ...
        {
            int stamp = GetTimeStamp(pk.Met_Year + 2000, pk.Met_Month, pk.Met_Day);
